...
public class JwtUtil {
    ...
    public Boolean validateToken(String token, String contextUser) {
        final String username = getClaims(token).get("email", String.class);
        return (username.equals(contextUser) && !isTokenExpired(token));
    }
}
